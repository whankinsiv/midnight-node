...
INSERT INTO tx_out ( id, tx_id                 , index, address          , address_raw, address_has_script, payment_cred, stake_address_id, value, data_hash )
            VALUES ( 11, init_ics_tx           , 0    , 'reserve address', ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- Reserve initial utxo - 250 tokens
                  ,( 12, init_ics_tx           , 1    , 'user address'   , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- 10 tokens, spend by user_transfer_tx_1
                  ,( 13, init_ics_tx           , 2    , 'user address'   , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- 880 tokens, spend by invalid_transfer_tx_1
                  ,( 14, init_ics_tx           , 3    , 'user address'   , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- 1000 tokens, spend by invalid_transfer_tx_2
                  ,( 15, irrelevant_tx         , 0    , 'non-ics addr'   , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- 10 tokens, spend by user_transfer_tx_2
                  ,( 16, irrelevant_tx         , 1    , 'non-ics addr'   , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- 10 tokens, spend by complex_withdraw_tx
                  ,( 21, reserve_transfer_tx   , 0    , 'ics address'    , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- output of reserve to ICS - 100 tokens
                  ,( 22, reserve_transfer_tx   , 1    , 'reserve address', ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- change of reserve to ICS transfer - 150 tokens
                  ,( 31, user_transfer_tx_1    , 0    , 'ics address'    , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- output of user_transfer_tx_1: 100 + 10 = 110 tokens
                  ,( 32, user_transfer_tx_2    , 0    , 'ics address'    , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- output of user_transfer_tx_2: 110 + 10 = 120 tokens
                  ,( 41, invalid_transfer_tx_1 , 0    , 'ics address'    , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- output of invalid_transfer_tx_1: 880 + 120 = 1000 tokens
                  ,( 42, invalid_transfer_tx_2 , 0    , 'ics address'    , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- output of invalid_transfer_tx_2: 1000 tokens
                  ,( 51, complex_withdraw_tx   , 0    , 'user address'   , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- user output of complex_withdraw_tx: 65 tokens
                  ,( 52, complex_withdraw_tx   , 1    , 'ics address'    , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- ics output of complex_withdraw_tx: 1995 tokens
                  ,( 53, complex_withdraw_tx   , 2    , 'reserve address', ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- reserve output of complex_withdraw_tx: 100 tokens
                  ,( 54, reserve_and_user_tx   , 0    , 'ics address'    , ''         , TRUE              , NULL        , NULL            , 0    , NULL     ) -- last tx only output from reserve, user and ICS to ICS
;
...
INSERT INTO tx_in (id, tx_in_id               , tx_out_id           , tx_out_index, redeemer_id )
           VALUES (1 , reserve_transfer_tx    , init_ics_tx         , 0           , NULL        )
           	     ,(2 , user_transfer_tx_1     , init_ics_tx         , 1           , NULL        )
                 ,(3 , user_transfer_tx_1     , reserve_transfer_tx , 0           , NULL        )
                 ,(4 , user_transfer_tx_2     , user_transfer_tx_1  , 0           , NULL        )
                 ,(5 , user_transfer_tx_2     , irrelevant_tx       , 0           , NULL        )
                 ,(6 , invalid_transfer_tx_1  , user_transfer_tx_2  , 0           , NULL        )
                 ,(7 , invalid_transfer_tx_1  , init_ics_tx         , 2           , NULL        )
                 ,(8 , invalid_transfer_tx_2  , init_ics_tx         , 3           , NULL        )
                 ,(9 , complex_withdraw_tx    , irrelevant_tx       , 1           , NULL        )
                 ,(10 , complex_withdraw_tx   , reserve_transfer_tx , 1           , NULL        )
                 ,(11 , complex_withdraw_tx   , invalid_transfer_tx_1 , 0         , NULL        )
                 ,(12 , complex_withdraw_tx   , invalid_transfer_tx_2 , 0         , NULL        )
                 ,(13 , reserve_and_user_tx   , complex_withdraw_tx   , 0         , NULL        )
                 ,(14 , reserve_and_user_tx   , complex_withdraw_tx   , 1         , NULL        )
                 ,(15 , reserve_and_user_tx   , complex_withdraw_tx   , 2         , NULL        )
;
